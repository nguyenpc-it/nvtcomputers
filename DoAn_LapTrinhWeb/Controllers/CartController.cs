            ...
            try
            {
                ...
                for (int i = 0; i < cart.Item1.Count; i++)
                {
                    ...
                    order.Order_Detail.Add(new Order_Detail
                    {
                        ...
                        quantity = cart.Item2[i],//get số lượng
                        status = "1",
                        update_at = DateTime.Now,
                        update_by = User.Identity.GetUserId().ToString()
                    }) ;
                    ...
                    ProductOrder += "<tr style='border-bottom: 1px solid rgba(0,0,0,.05);' class='product_item'>"+
                                        "<td valign='middle' width ='80%' style='text-align:left; padding:0 2.5em;'> " +
                                            "<div class='product-entry'>" +
                                                "<img src='" + Request.Url.Scheme + "://" + Request.Url.Authority + "/" + item.image+"' style ='width: 100px; max-width: 600px; height: auto; padding-bottom:5px; display: block;'>" +
                                                "<div class='text'>" +
                ...
                {                  
                    ...
                    case 5://thanh toán bằng zalo pay
                        ...
                        var description = "NVTComputer - Thanh toán đơn hàng #" + order.order_id;
